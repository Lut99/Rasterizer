...
#ifndef VULKAN_MEMORY_POOL_HPP
#define VULKAN_MEMORY_POOL_HPP
...
namespace Rasterizer::Vulkan {
    ...
    public:
        ...
        MemoryPool(const Vulkan::GPU& gpu, uint32_t memory_type, VkDeviceSize n_bytes, VkMemoryPropertyFlags memory_properties = 0);
        ...
        static uint32_t select_memory_type(const Vulkan::GPU& gpu, VkBufferUsageFlags usage_flags = 0, VkMemoryPropertyFlags memory_properties = 0, VkSharingMode sharing_mode = VK_SHARING_MODE_EXCLUSIVE, VkBufferCreateFlags create_flags = 0);
        /* Static function that helps users decide the best memory queue for images. */
        static uint32_t select_memory_type(const Vulkan::GPU& gpu, VkFormat format, VkImageLayout layout, VkImageUsageFlags usage_flags, VkMemoryPropertyFlags memory_properties, VkSharingMode sharing_mode = VK_SHARING_MODE_EXCLUSIVE, VkImageCreateFlags create_flags = 0);
