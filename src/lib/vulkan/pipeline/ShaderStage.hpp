...
#ifndef VULKAN_SHADER_STAGE_HPP
#define VULKAN_SHADER_STAGE_HPP
...
namespace Rasterizer::Vulkan {
    ...
    public:
        ...
        ShaderStage(const Vulkan::Shader& shader, VkShaderStageFlagBits shader_stage, const std::unordered_map<uint32_t, Vulkan::BinaryString>& specialization_constants = {});
