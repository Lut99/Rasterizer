...
{
    DENTER("Vulkan::DescriptorSetLayout::DescriptorSetLayout(copy)");
...
uint32_t DescriptorSetLayout::add_binding(VkDescriptorType vk_descriptor_type, uint32_t n_descriptors, VkShaderStageFlags vk_shader_stage) {
    DENTER("Vulkan::DescriptorSetLayout::add_binding");
...
void DescriptorSetLayout::finalize() {
    DENTER("Vulkan::DescriptorSetLayout::finalize");
...
void Vulkan::swap(DescriptorSetLayout& dsl1, DescriptorSetLayout& dsl2) {
    DENTER("Vulkan::swap(DescriptorSetLayout)");
