...
namespace Makma3D::Rendering {
    ...
    public:
        ...
        inline void preallocate(uint32_t pipeline_index, const Rendering::PipelineProperties& properties, const Rendering::RenderPass& render_pass, uint32_t first_subpass) { return this->preallocate(pipeline_index, Rendering::PipelineProperties(properties), render_pass, first_subpass); }
