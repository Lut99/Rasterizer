...
namespace Rasterizer::Rendering {
    ...
    public:
        /* Schedules an image layout transition on the given command buffer by using a pipeline barrier. */
        void transition(VkImageLayout new_layout, const Rendering::CommandBuffer& command_buffer);
