...
#ifndef RENDERING_RENDER_PASS_HPP
#define RENDERING_RENDER_PASS_HPP

#include <vulkan/vulkan.h>

#include "render_engine/gpu/GPU.hpp"
#include "render_engine/commandbuffers/CommandBuffer.hpp"
#include "render_engine/swapchain/Framebuffer.hpp"
...
namespace Rasterizer::Rendering {
    ...
    private:
        ...
        Tools::Array<Rendering::Subpass> subpasses;
    ...
    public:
        ...
        RenderPass(const Rendering::GPU& gpu);
